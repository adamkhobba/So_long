...
void img_ptr(t_data *data) {
  ...
  height = 64;
  data->wall =
      mlx_xpm_file_to_image(data->mlx, "./textures/wall.xpm", &width, &height);
  data->floor =
      mlx_xpm_file_to_image(data->mlx, "./textures/floor.xpm", &width, &height);
  data->coin =
      mlx_xpm_file_to_image(data->mlx, "./textures/coin1.xpm", &width, &height);
...
int put_player(t_data *data) {
  ...
  height = 64;
  if (data->view == 2)
    data->player = mlx_xpm_file_to_image(data->mlx, "./textures/Character.xpm",
                                         &width, &height);
  else if (data->view == 1)
    data->player = mlx_xpm_file_to_image(
        data->mlx, "./textures/Character_top.xpm", &width, &height);
  else if (data->view == 3)
    data->player = mlx_xpm_file_to_image(
        data->mlx, "./textures/Character_right2.xpm", &width, &height);
  else if (data->view == 4)
    data->player = mlx_xpm_file_to_image(
        data->mlx, "./textures/Character_left.xpm", &width, &height);
